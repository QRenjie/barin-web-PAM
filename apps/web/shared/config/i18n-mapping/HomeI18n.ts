...
export const homeI18n = Object.freeze({
  ...
  environmentsLabel: i18nKeys.PAGE_HOME_ENVIRONMENTS_LABEL,
  noEnvironments: i18nKeys.PAGE_HOME_NO_ENVIRONMENTS,
  formEnvironments: i18nKeys.PAGE_HOME_FORM_ENVIRONMENTS,
  formEnvironmentsHint: i18nKeys.PAGE_HOME_FORM_ENVIRONMENTS_HINT,
  formEnvName: i18nKeys.PAGE_HOME_FORM_ENV_NAME,
  formEnvNamePlaceholder: i18nKeys.PAGE_HOME_FORM_ENV_NAME_PLACEHOLDER,
  formEnvUrl: i18nKeys.PAGE_HOME_FORM_ENV_URL,
  formEnvUrlInvalid: i18nKeys.PAGE_HOME_FORM_ENV_URL_INVALID,
  formAddEnvironment: i18nKeys.PAGE_HOME_FORM_ADD_ENVIRONMENT,
  formRemoveEnvironment: i18nKeys.PAGE_HOME_FORM_REMOVE_ENVIRONMENT,
